...
A Project of Udacity Deep Learning Nanodegree program  where  I learned how to build a pipeline to process real-world, user-supplied images and deployed the trained model into an app. Given an image, The app will predict the most likely locations where the image was taken. Predicted 50 Landmarks in total.
